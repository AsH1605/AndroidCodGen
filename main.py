...
import modal.gpu
image=modal.Image.debian_slim(python_version="3.10").pip_install(["torch","transformers==4.45.2","numpy","pandas","torchvision","Pillow","scikit-learn","sentencepiece","peft==0.14.0","datasets"])
...
# Load pre-trained model and tokenizer
    ...
    data['instruction']="You are a coding assistant. Given following coding problem, provide a clear and detailed solution."
